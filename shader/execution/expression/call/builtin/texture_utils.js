...
**/ /**
* AUTO-GENERATED - DO NOT EDIT. Source: https://github.com/gpuweb/cts
**/import { keysOf } from '../../../../../../common/util/data_tables.js';import { assert, range, unreachable } from '../../../../../../common/util/util.js';import { Float16Array } from '../../../../../../external/petamoriken/float16/float16.js';import {
  is32Float,
...
export async function queryMipLevelMixWeightsForDevice(t, stage) {
  ...
  globalThis._TRAMPOLINE_("destroy", storageBuffer, storageBuffer.destroy, [], () => globalThis._TRAMPOLINE_("destroy", storageBuffer, storageBuffer.destroy, [], () => storageBuffer.destroy()));
...
`);
          ...
          ...(await identifySamplePoints(
            ...
            async (texels) => {
              ...
              globalThis._TRAMPOLINE_("destroy", gpuTexture, gpuTexture.destroy, [], () => globalThis._TRAMPOLINE_("destroy", gpuTexture, gpuTexture.destroy, [], () => gpuTexture.destroy()));
              return result;
            }
          ))];
  ...
  globalThis._TRAMPOLINE_("destroy", results.runner, results.runner.destroy, [], () => globalThis._TRAMPOLINE_("destroy", results.runner, results.runner.destroy, [], () => results.runner.destroy()));
  globalThis._TRAMPOLINE_("destroy", checkInfo.runner, checkInfo.runner.destroy, [], () => globalThis._TRAMPOLINE_("destroy", checkInfo.runner, checkInfo.runner.destroy, [], () => checkInfo.runner.destroy()));
...
format)
{
  ...
  for (const { readBuffer, size } of readBuffers) {
    await globalThis._TRAMPOLINE_("mapAsync", readBuffer, readBuffer.mapAsync, [GPUMapMode.READ], () => globalThis._TRAMPOLINE_("mapAsync", readBuffer, readBuffer.mapAsync, [GPUMapMode.READ], () => readBuffer.mapAsync(GPUMapMode.READ)));
...
function describeTextureCall(call) {
  ...
  for (const name of kTextureCallArgNames) {
    ...
    if (value !== undefined && name !== 'component') {
      ...
      } else if (name === 'ddx' || name === 'ddy') {args.push(`${name}: ${wgslExprFor(value, call.coordType)}`);} else if (name === 'mipLevel') {
...
`;
  ...
  return {
    run,
    destroy() {
      globalThis._TRAMPOLINE_("destroy", dataBuffer, dataBuffer.destroy, [], () => globalThis._TRAMPOLINE_("destroy", dataBuffer, dataBuffer.destroy, [], () => dataBuffer.destroy()));
      globalThis._TRAMPOLINE_("destroy", renderTarget, renderTarget.destroy, [], () => globalThis._TRAMPOLINE_("destroy", renderTarget, renderTarget.destroy, [], () => renderTarget.destroy()));
    }
  };
}

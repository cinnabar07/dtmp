...
**/ /**
* AUTO-GENERATED - DO NOT EDIT. Source: https://github.com/gpuweb/cts
**/import { checkElementsPassPredicate } from '../../../util/check_contents.js';import { align } from '../../../util/math.js';import { PRNG } from '../../../util/prng.js';
...
export class MemoryModelTester {
  ...
  async run(iterations, weakIndex) {
    for (let i = 0; i < iterations; i++) {
      ...
      const encoder = globalThis._TRAMPOLINE_("createCommandEncoder", this.test.device, this.test.device.createCommandEncoder, [], () => globalThis._TRAMPOLINE_("createCommandEncoder", this.test.device, this.test.device.createCommandEncoder, [], () => this.test.device.createCommandEncoder()));
      ...
      globalThis._TRAMPOLINE_("submit", this.test.device, this.test.device.queue.submit, [[encoder.finish()]], () => globalThis._TRAMPOLINE_("submit", this.test.device, this.test.device.queue.submit, [[encoder.finish()]], () => this.test.device.queue.submit([encoder.finish()])));
  ...
  async setShuffledWorkgroups(numWorkgroups) {
    await globalThis._TRAMPOLINE_("mapAsync", this.buffers.shuffledWorkgroups.srcBuf, this.buffers.shuffledWorkgroups.srcBuf.mapAsync, [GPUMapMode.WRITE], () => globalThis._TRAMPOLINE_("mapAsync", this.buffers.shuffledWorkgroups.srcBuf, this.buffers.shuffledWorkgroups.srcBuf.mapAsync, [GPUMapMode.WRITE], () => this.buffers.shuffledWorkgroups.srcBuf.mapAsync(GPUMapMode.WRITE)));
  ...
  async setScratchLocations(numWorkgroups) {
    await globalThis._TRAMPOLINE_("mapAsync", this.buffers.scratchMemoryLocations.srcBuf, this.buffers.scratchMemoryLocations.srcBuf.mapAsync, [GPUMapMode.WRITE], () => globalThis._TRAMPOLINE_("mapAsync", this.buffers.scratchMemoryLocations.srcBuf, this.buffers.scratchMemoryLocations.srcBuf.mapAsync, [GPUMapMode.WRITE], () => this.buffers.scratchMemoryLocations.srcBuf.mapAsync(GPUMapMode.WRITE)));
  ...
  async setStressParams() {
    await globalThis._TRAMPOLINE_("mapAsync", this.buffers.stressParams.srcBuf, this.buffers.stressParams.srcBuf.mapAsync, [GPUMapMode.WRITE], () => globalThis._TRAMPOLINE_("mapAsync", this.buffers.stressParams.srcBuf, this.buffers.stressParams.srcBuf.mapAsync, [GPUMapMode.WRITE], () => this.buffers.stressParams.srcBuf.mapAsync(GPUMapMode.WRITE)));

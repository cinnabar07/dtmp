...
`;import { makeTestGroup } from '../../../../common/framework/test_group.js';import { GPUTest } from '../../../gpu_test.js';import { PRNG } from '../../../util/prng.js';
...
function runTest(t) {
  ...
  globalThis._TRAMPOLINE_("submit", t.device, t.device.queue.submit, [[commands]], () => globalThis._TRAMPOLINE_("submit", t.device, t.device.queue.submit, [[commands]], () => t.device.queue.submit([commands])));

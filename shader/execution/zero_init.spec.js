...
**/ /**
* AUTO-GENERATED - DO NOT EDIT. Source: https://github.com/gpuweb/cts
**/export const description = `Test that variables in the shader are zero initialized`;import { makeTestGroup } from '../../../common/framework/test_group.js';import { iterRange, unreachable } from '../../../common/util/util.js';import { GPUTest } from '../../gpu_test.js';
import {
...
fn(async (t) => {
  ...
  if (t.params.addressSpace === 'workgroup') {
    ...
    const e = globalThis._TRAMPOLINE_("createCommandEncoder", t.device, t.device.createCommandEncoder, [], () => globalThis._TRAMPOLINE_("createCommandEncoder", t.device, t.device.createCommandEncoder, [], () => t.device.createCommandEncoder()));
    const p = e.beginComputePass();
    p.setPipeline(fillPipeline);
    p.setBindGroup(0, bg);
    p.dispatchWorkgroups(1);
    p.end();
    globalThis._TRAMPOLINE_("submit", t, t.queue.submit, [[e.finish()]], () => globalThis._TRAMPOLINE_("submit", t, t.queue.submit, [[e.finish()]], () => t.queue.submit([e.finish()])));
  }

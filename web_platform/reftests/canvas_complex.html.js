...
**/ /**
* AUTO-GENERATED - DO NOT EDIT. Source: https://github.com/gpuweb/cts
**/import { assert, unreachable } from '../../../common/util/util.js';import { kTextureFormatInfo } from '../../format_info.js';import { gammaDecompress, float32ToFloat16Bits } from '../../util/conversion.js';import { align } from '../../util/math.js';
...
targets)
{
  runRefTest(async (t) => {
    ...
    function copyBufferToTexture(ctx) {
      ...
      }], () => globalThis._TRAMPOLINE_("createBuffer", t.device, t.device.createBuffer, [{ mappedAtCreation: true, size: rows * bytesPerRow, usage: GPUBufferUsage.COPY_SRC }], () => t.device.createBuffer({ mappedAtCreation: true, size: rows * bytesPerRow, usage: GPUBufferUsage.COPY_SRC })));

...
`;import { SkipTestCase } from '../../../common/framework/fixture.js';import { makeTestGroup } from '../../../common/framework/test_group.js';import { timeout } from '../../../common/util/timeout.js';
...
fn((t) => {
  ...
  globalThis._TRAMPOLINE_("destroy", frameTexture, frameTexture.destroy, [], () => globalThis._TRAMPOLINE_("destroy", frameTexture, frameTexture.destroy, [], () => frameTexture.destroy()));

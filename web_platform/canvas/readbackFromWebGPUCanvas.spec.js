...
`;import { makeTestGroup } from '../../../common/framework/test_group.js';import { ErrorWithExtra,
assert,
...
canvasType)
{
  ...
  globalThis._TRAMPOLINE_("destroy", tempTexture, tempTexture.destroy, [], () => globalThis._TRAMPOLINE_("destroy", tempTexture, tempTexture.destroy, [], () => tempTexture.destroy()));

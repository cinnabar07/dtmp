...
fn((t) => {
  ...
  sourceDevice, sourceDevice.createBuffer, [{
    size: 16,
    usage: GPUBufferUsage.INDEX
  }], () => globalThis._TRAMPOLINE_("createBuffer", sourceDevice, sourceDevice.createBuffer, [{ size: 16, usage: GPUBufferUsage.INDEX }], () => sourceDevice.createBuffer({ size: 16, usage: GPUBufferUsage.INDEX })))
  );

...
fn((t) => {
  ...
  indirectDevice, indirectDevice.createBuffer, [{
    size: 256,
    usage: GPUBufferUsage.INDIRECT
  }], () => globalThis._TRAMPOLINE_("createBuffer", indirectDevice, indirectDevice.createBuffer, [{ size: 256, usage: GPUBufferUsage.INDIRECT }], () => indirectDevice.createBuffer({ size: 256, usage: GPUBufferUsage.INDIRECT })))
  );
  const drawCountBuffer = useDrawCountBuffer ?
  ...
  drawCountDevice, drawCountDevice.createBuffer, [{
    size: 256,
    usage: GPUBufferUsage.INDIRECT
  }], () => globalThis._TRAMPOLINE_("createBuffer", drawCountDevice, drawCountDevice.createBuffer, [{ size: 256, usage: GPUBufferUsage.INDIRECT }], () => drawCountDevice.createBuffer({ size: 256, usage: GPUBufferUsage.INDIRECT })))
  ) :
  undefined;

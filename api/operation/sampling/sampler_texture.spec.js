...
`;import { makeTestGroup } from '../../../../common/framework/test_group.js';import { assert, range } from '../../../../common/util/util.js';import { MaxLimitsTest, TextureTestMixin } from '../../../gpu_test.js';
...
${declarationLines.join('\n')}
  ...
  textures.forEach((texture) => globalThis._TRAMPOLINE_("destroy", texture, texture.destroy, [], () => globalThis._TRAMPOLINE_("destroy", texture, texture.destroy, [], () => texture.destroy())));
});

...
t)
{
  ...
  if (!sampling) {
    ...
    globalThis._TRAMPOLINE_("submit", device, device.queue.submit, [[commandBuffer]], () => globalThis._TRAMPOLINE_("submit", device, device.queue.submit, [[commandBuffer]], () => device.queue.submit([commandBuffer])));

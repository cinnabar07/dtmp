...
export class GPUTestBase extends Fixture {
  ...
  createCopyForMapRead(src, srcOffset, size) {
    ...
    const c = globalThis._TRAMPOLINE_("createCommandEncoder", this.device, this.device.createCommandEncoder, [], () => globalThis._TRAMPOLINE_("createCommandEncoder", this.device, this.device.createCommandEncoder, [], () => this.device.createCommandEncoder()));
    c.copyBufferToBuffer(src, srcOffset, dst, 0, size);
    globalThis._TRAMPOLINE_("submit", this, this.queue.submit, [[c.finish()]], () => globalThis._TRAMPOLINE_("submit", this, this.queue.submit, [[c.finish()]], () => this.queue.submit([c.finish()])));
  ...
  })
  {
    ...
    await globalThis._TRAMPOLINE_("mapAsync", mappable, mappable.mapAsync, [GPUMapMode.READ, mapOffset, mapSize], () => globalThis._TRAMPOLINE_("mapAsync", mappable, mappable.mapAsync, [GPUMapMode.READ, mapOffset, mapSize], () => mappable.mapAsync(GPUMapMode.READ, mapOffset, mapSize)));
    ...
    return {
      ...
      cleanup() {
        mappable.unmap();
        globalThis._TRAMPOLINE_("destroy", mappable, mappable.destroy, [], () => globalThis._TRAMPOLINE_("destroy", mappable, mappable.destroy, [], () => mappable.destroy()));
      }
    };
  }
  ...
  createBufferTracked(descriptor) {
    return this.trackForCleanup(globalThis._TRAMPOLINE_("createBuffer", this.device, this.device.createBuffer, [descriptor], () => globalThis._TRAMPOLINE_("createBuffer", this.device, this.device.createBuffer, [descriptor], () => this.device.createBuffer(descriptor))));
  }

...
**/ /**
* AUTO-GENERATED - DO NOT EDIT. Source: https://github.com/gpuweb/cts
**/import { assert, ErrorWithExtra, unreachable } from '../../../common/util/util.js';import { kTextureFormatInfo } from '../../format_info.js';import { numbersApproximatelyEqual } from '../conversion.js';import { generatePrettyTable, numericToStringBuilder } from '../pretty_diff_tables.js';
...
{ format })
{
  ...
  const cmd = globalThis._TRAMPOLINE_("createCommandEncoder", t.device, t.device.createCommandEncoder, [], () => globalThis._TRAMPOLINE_("createCommandEncoder", t.device, t.device.createCommandEncoder, [], () => t.device.createCommandEncoder()));
  cmd.copyTextureToBuffer(source, { buffer, bytesPerRow, rowsPerImage }, copySize);
  globalThis._TRAMPOLINE_("submit", t.device, t.device.queue.submit, [[cmd.finish()]], () => globalThis._TRAMPOLINE_("submit", t.device, t.device.queue.submit, [[cmd.finish()]], () => t.device.queue.submit([cmd.finish()])));

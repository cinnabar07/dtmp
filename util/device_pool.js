...
**/ /**
* AUTO-GENERATED - DO NOT EDIT. Source: https://github.com/gpuweb/cts
**/import { SkipTestCase } from '../../common/framework/fixture.js';import { attemptGarbageCollection } from '../../common/util/collect_garbage.js';import { getGPU, getDefaultRequestAdapterOptions } from '../../common/util/navigator_gpu.js';import { assert,
    ...
    try {
      ...
      if (!(ex instanceof TestFailedButDeviceReusable)) {
        ...
        if ('destroy' in holder.device) {
          globalThis._TRAMPOLINE_("destroy", holder.device, holder.device.destroy, [], () => globalThis._TRAMPOLINE_("destroy", holder.device, holder.device.destroy, [], () => holder.device.destroy()));
...
class DeviceHolder {
  ...
  descriptorModifierFn)
  {
    ...
    const device = await globalThis._TRAMPOLINE_("requestDevice", adapter, adapter.requestDevice, [descriptor], () => globalThis._TRAMPOLINE_("requestDevice", adapter, adapter.requestDevice, [descriptor], () => adapter.requestDevice(descriptor)));
  ...
  async attemptEndTestScope() {
    ...
    globalThis._TRAMPOLINE_("submit", this.device, this.device.queue.submit, [[]], () => globalThis._TRAMPOLINE_("submit", this.device, this.device.queue.submit, [[]], () => this.device.queue.submit([])));

...
**/ /**
* AUTO-GENERATED - DO NOT EDIT. Source: https://github.com/gpuweb/cts
**/export const kRenderEncodeTypes = ['render pass', 'render bundle'];export const kProgrammableEncoderTypes = ['compute pass', ...kRenderEncodeTypes];
...
export class CommandBufferMaker {
  ...
  finish)
  {
    ...
    submitShouldSucceedIfValid) =>
    {
      ...
      if (shouldBeValid) {
        t.expectValidationError(() => globalThis._TRAMPOLINE_("submit", t, t.queue.submit, [[commandBuffer]], () => globalThis._TRAMPOLINE_("submit", t, t.queue.submit, [[commandBuffer]], () => t.queue.submit([commandBuffer]))), !submitShouldSucceedIfValid);
      }
    };
